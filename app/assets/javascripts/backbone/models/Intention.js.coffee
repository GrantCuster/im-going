  ...
  order: () ->
    ...
    _.each intention_one, (intention, i) ->
      ...
      if intention_one_count == 1
        intention_choices = intention_choices + "<a href='/user/#{user_id}'>#{username}</a> is going. "
      else
        if i == intention_one_count - 1
          intention_choices = intention_choices + " and <a href='/user/#{user_id}'>#{username}</a> are going. "
        else if i == intention_one_count - 2
          intention_choices = intention_choices + "<a href='/user/#{user_id}'>#{username}</a> "
        else
          intention_choices = intention_choices + "<a href='/user/#{user_id}'>#{username}</a>, "
    ...
    _.each intention_two, (intention, i) ->
      ...
      user_id = intention.getUserID()
      if intention_one_count == 1
        intention_choices = intention_choices + "<a href='/user/#{user_id}'>#{username}</a> is thinking about it. "
      else
        if i == intention_two_count - 1
          intention_choices = intention_choices + " and <a href='/user/#{user_id}'>#{username}</a> are thinking about it. "
    ...
    _.each intention_three, (intention, i) ->
      ...
      user_id = intention.getUserID()
      if intention_one_count == 1
        intention_choices = intention_choices + "<a href='/user/#{user_id}'>#{username}</a> would go if somebody else does. "
      else
        if i == intention_three_count - 1
          intention_choices = intention_choices + " and <a href='/user/#{user_id}'>#{username}</a> would go if somebody else does. "
